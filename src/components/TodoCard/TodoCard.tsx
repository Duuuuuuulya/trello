...
const TodoCard = ({text, difficult, taskOwner, header, taskId, columnId} : TodoCardProps) => {
  ...
  return (
    ...
    <div className="taskWrapper" >
      ...
      <button className="editButton" onClick={() => setEditOpen(true)}>Edit Task</button>
      <button className="deleteButton"onClick={() => columns.deleteTask(taskId, columnId)}>Delete Task</button>
      </div>
      </div>
    </div>
    : <div className="editCardWrapper">
        ...
        <input className="editInput" placeholder="Header"  onChange={handleChangeHeader} value={headerValue}/>
        <input className="editInput" placeholder="Text" onChange={handleChangeTaskText} value={textValue}/>
        <input type="number" className="editInput" placeholder="Difficult" onChange={handleChangeTaskDifficult} value={difficultValue}/>
        <input className="editInput" placeholder="Task Owner" onChange={handleChangeTaskOwner} value={taskOwnerValue}/>
        <div className="confirmEditCardWrapper">
        <button className="confirmEditCard" onClick={() => {columns.endEditFunc(taskId, columnId, headerValue, textValue, difficultValue, taskOwnerValue); setEditOpen(false)}}>Confirm Edit</button>
        </div>
